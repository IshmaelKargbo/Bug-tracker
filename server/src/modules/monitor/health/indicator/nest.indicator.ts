...
import { BaseHealthIndicator } from './basic.indicator';
...
{
  public readonly name = 'iBug Server';
  ...
  public async isHealthy(): Promise<HealthIndicatorResult> {
    if (this.isDefined(this.url)) {
      ...
      // of Terminus throws an error that need to be cached in the HealthService
